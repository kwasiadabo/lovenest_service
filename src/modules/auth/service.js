...
async function login(email, password) {
  ...
  return {
    ...
    user: {
      ...
      schoolBrandColor: user.School ? user.School.brandColor : null,
      schoolBrandColorSecondary: user.School ? user.School.brandColorSecondary : null,
      schoolIdCardTemplate: user.School ? user.School.idCardTemplate : 'classic',
